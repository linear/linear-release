...
echo ""
echo "Reminder: after the release is published, cut a matching linear-release-action release by running './scripts/release.sh $VERSION' from a clean main checkout of linear-release-action."
